...
<div class="container">
    ...
    <form name="memberdetail" method="post">
	    <table border="1" class="table table-hover">
	        ...
	        <tr>
	            <td>닉네임</td>
	            <td><input type="text" name="m_nick" id="m_nick" value="${detail.m_nick}"></td>
	        </tr>
	        ...
	        <tr>
	   		  <th>이메일 수신여부</th>
	    		<td>
	       			 <input type="checkbox" name="m_mailcheck" id="m_mailcheck" onclick="getCheckboxValue()" value="${detail.m_mailcheck}">
	    		</td>
			</tr>
			<tr>
			    <th>sms 수신여부</th>
			    <td>
			        <input type="checkbox" name="m_smscheck" id="m_smscheck" onclick="getCheckboxValue()" value="${detail.m_smscheck}">
			    </td>
			</tr>
	        <tr>
    ...
    function memupdate(){
    	...
    	document.memberdetail.action="/member/memberupate";
