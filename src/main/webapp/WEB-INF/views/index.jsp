		...
		<c:forEach items="${mdComm}" var="comm" varStatus="vs">
	      <div class="col-md-6 mb-5 mb-lg-0 col-lg-4">
	        <div class="blog_entry">
	          <a href="#"><img src="/storage/${comm.c_banner}" alt="community banner" class="img-fluid"></a>
	          <div class="p-4 bg-white">
	            <h3><a href="#">${comm.c_name}</a></h3>
	            <span class="date">${comm.c_rdate.substring(0,11)}</span>
	            <p>${comm.c_des}</p>
	            <p class="more"><a href="#">여기 어때?</a></p>
	          </div>
	        </div>
	        </div>
		</c:forEach>
          ...
          <div class="col-12">
            <div class="widget">
              <ul class="links list-unstyled">
                ...
                <li>&#127744 강한이 / 기술자문 / <a href="/comm/index">커뮤니티페이지</a>, <a href="/notice/list?pageNum=1">공지사항페이지</a>, <a href="/admin/dashboard">관리자페이지</a></li>
